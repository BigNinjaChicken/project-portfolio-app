...
<script>
	...
	let projects = [
		...
		},
		{
			...
			description:
				'I created the frontend and backend for the application using SvelteKit, and for the aesthetics, I used Tailwind and SkeletonUI. This site demonstrates both my achievements and my projects. I put much work into my experiences, and it is only fair to give it a platform to display it.',
			image: Site
		},
		{
			title: 'Express Polar',
